...
enum class DataAccessType() {
    HTTP_HISTORY(), WEBSOCKET_HISTORY(), ORGANIZER(), COOKIES();
}
        ...
        return suspendCoroutine { continuation ->
            SwingUtilities.invokeLater {
                val accessTypeName = when (accessType) {
                    ...
                    DataAccessType.COOKIES -> "Cookie jar"
                }
                ...
                when (result) {
                    ...
                    1 -> {
                        when (accessType) {
                            ...
                            DataAccessType.COOKIES -> config.alwaysAllowCookies = true
                        }
                        continuation.resume(true)
                    }
...
object DataAccessSecurity {
    ...
    suspend fun checkDataAccessPermission(
        ...
        val isAlwaysAllowed = when (accessType) {
            ...
            DataAccessType.COOKIES -> config.alwaysAllowCookies
        }
